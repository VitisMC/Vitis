...
// CookieRequest is sent by the server to request a cookie from the client during configuration.
...
func (p *CookieRequest) ID() int32 {
	return int32(packetid.ClientboundConfigCookieRequest)
}
...
// CookieResponse is sent by the client in response to a cookie request during configuration.
...
func (p *CookieResponse) ID() int32 {
	return int32(packetid.ServerboundConfigCookieResponse)
}
