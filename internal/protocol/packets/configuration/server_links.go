...
// ServerLink represents a single server link entry.
...
// ClientboundServerLinks sends server links to the client during configuration.
...
func (p *ClientboundServerLinks) ID() int32 {
	return int32(packetid.ClientboundConfigServerLinks)
}
...
// ServerboundServerLinks is sent by the client to acknowledge server links during configuration.
type ServerboundServerLinks struct{}

func NewServerboundServerLinks() protocol.Packet { return &ServerboundServerLinks{} }

func (p *ServerboundServerLinks) ID() int32 {
	return int32(packetid.ServerboundConfigServerLinks)
}

func (p *ServerboundServerLinks) Decode(_ *protocol.Buffer) error { return nil }
func (p *ServerboundServerLinks) Encode(_ *protocol.Buffer) error { return nil }
