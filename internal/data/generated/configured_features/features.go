// Code generated by internal/data/generator/configured_features; DO NOT EDIT.

package configuredfeatures

const ConfiguredFeatureCount = 204

var ConfiguredFeatures = []string{
	"minecraft:acacia",
	...
	"minecraft:single_piece_of_grass",
